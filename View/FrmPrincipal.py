...
class Ui_FrmPrincipal(object):
    def setupUi(self, FrmPrincipal):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("./Imagens/unknown.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"")
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("./Imagens/Aluguel_veiculo.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"")
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("./Imagens/Cadastrar_cliente.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"")
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("./Imagens/Lista_cliente.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"")
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("./Imagens/Lista_Veiculos.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"")
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("./Imagens/Lista_aluguel.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.lbImg.setText("")
        self.lbImg.setPixmap(QtGui.QPixmap("./Imagens/Logo_Meca.jpeg"))#Logo_Meca #Logo_uno_escada
