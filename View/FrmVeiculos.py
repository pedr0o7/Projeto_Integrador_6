...
class Ui_frmVeiculos(object):
    ...
    def setupUi(self, frmVeiculos, estado, codigoVeic):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("D:\PyCharm\projetos\Projeto_Python-20210805T211248Z-001\Projeto_Python\Imagens/Cadastrar_veiculo_preto.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"")
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("D:\PyCharm\projetos\Projeto_Python-20210805T211248Z-001\Projeto_Python\Imagens/Salvar.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off) ####VER OUTRO MODO!!
